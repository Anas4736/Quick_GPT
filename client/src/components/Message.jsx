    ...
    <div>
      {message.role === 'user' ? (
        <div className='flex items-start justify-end my-4 gap-2'>
          ...
          <p className='text-sm dark:test-primary'>{message.content}</p>
      ...
      : (
        <div className='inline-flex flex-col gap-2 p-2 px-4 max-w-2x1 bg-primary/20 dark:bg-[#57317C]/30 border border-[#80609F]/30 rounded-md-4'>
        {message.isImage ? (
